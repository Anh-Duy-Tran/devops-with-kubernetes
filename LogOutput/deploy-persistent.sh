...
kubectl rollout status deployment/pingpong-app --timeout=120s
kubectl rollout status deployment/log-output-app --timeout=120s
...
echo ""
echo "Pod Status:"
kubectl get pods -l app=pingpong-app -o wide
kubectl get pods -l app=log-output-app -o wide
echo ""
echo "Services:"
kubectl get services
echo ""
echo "Useful commands:"
echo "  Test PingPong: kubectl port-forward service/pingpong-service 8080:8080"
echo "  Test LogOutput: kubectl port-forward service/log-output-service 8081:8080"
echo "  View PingPong logs: kubectl logs -l app=pingpong-app -f"
echo "  View LogOutput logs: kubectl logs -l app=log-output-app --all-containers=true -f"
echo "  Check persistent volume: kubectl exec -it deployment/pingpong-app -- ls -la /usr/src/app/files/"
